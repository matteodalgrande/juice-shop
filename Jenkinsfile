...
//         - "./cc-test-reporter upload-coverage"
                ...
                sh './test-reporter-latest-linux-amd64 --debug format-coverage -t lcov -o build/reports/coverage/codeclimate.frontend.json -p build/reports/coverage/ng/lcov.info' 
